							...
							<table class="table" style="border : 1px solid #CED4DA;">
								<tbody>
									...
									<tr>
										...
										<td colspan="2"><input type="number" name="book_discount" id="book_discount" value="" style="width:100%;"></td>
									</tr>
									<tr>
...
putBtn.onclick = function () {
	...
	console.log("book_discount : " + book_discount.value);
...
//       }
	...
	if(parseFloat($("#book_discount").val()) > 1.0 || parseFloat($("#book_discount").val()) == ""){
		Swal.fire("할인률 정보가 맞지 않습니다.");
		return false;
	}

	if(parseFloat($("#book_margin").val()) < 0 || parseFloat($("#book_margin").val()) == ""){
		Swal.fire("마진률 정보가 맞지 않습니다.");
		return false;
	}
