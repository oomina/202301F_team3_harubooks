				...
				<div id="categoryInsertDisp" >
					<table>
						<tr>
							...
							<td style="width:60%;"><input type="text" id="cc_nm" style="width:168%; border: 1px solid lightgrey;"></td>
						</tr>
					</table>
				</div>
			</div>
			...
			<div style="float: left; width: 100%; border: 1px solid lightgrey;">
				<div id="categoryUpdateDisp" >
					<table>
						<tr>
							<th class="table-primary" style="width:40%; text-align : center;">카테고리명</th>
							<td style="width:60%;"><input type="text" id="new_cc_nm" style="width:168%; border: 1px solid lightgrey;"></td>
						</tr>
					</table>
				</div>
			</div>
