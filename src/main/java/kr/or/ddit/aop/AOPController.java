...
public class AOPController {
	...
	@Around("execution(* kr.or.ddit.service.*.*(..))"
			+ "|| execution(* kr.or.ddit.service.jhs.*.*(..))"
			+ "|| execution(* kr.or.ddit.service.bmk.*.*(..))"
			+ "|| execution(* kr.or.ddit.service.kmw.*.*(..))"
			+ "|| execution(* kr.or.ddit.service.ljy.*.*(..))"
			+ "|| execution(* kr.or.ddit.service.odh.*.*(..))"
			+ "|| execution(* kr.or.ddit.service.omn.books.*.*(..))"
			+ "|| execution(* kr.or.ddit.service.omn.mbr.*.*(..))"
			+ "|| execution(* kr.or.ddit.service.omn.sales.*.*(..))")
