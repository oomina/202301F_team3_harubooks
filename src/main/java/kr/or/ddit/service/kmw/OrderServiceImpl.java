...
public class OrderServiceImpl implements OrderService{
	...
	@Override
	public int completePurCnt(String ae_id) {
		return mapper.completePurCnt(ae_id);
	}

	@Override
	public List<OrderVO> pagingComplete(PagingVO<OrderVO> pagingVO) {
		return mapper.pagingComplete(pagingVO);
	}

	@Override
	public int refundListCnt(String ae_id) {
		return mapper.refundListCnt(ae_id);
	}

	@Override
	public List<OrderVO> pagingRefundList(PagingVO<OrderVO> pagingVO) {
		return mapper.pagingRefundList(pagingVO);
	}
}
