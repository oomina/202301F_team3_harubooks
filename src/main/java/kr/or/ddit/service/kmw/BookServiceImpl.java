...
public class BookServiceImpl implements BookService{
	...
	@Override
	public List<BookInfoVO> selectBookListAll(PaginationVO<BookInfoVO> pagingVO) {
		return mapper.selectBookListAll(pagingVO);
	}


	@Override
	public int reviewCheck(BookInfoVO bookVO) {
		return mapper.reviewCheck(bookVO);
	}


	@Override
	public int reviewCheck2(BookInfoVO bookVO) {
		return mapper.reviewCheck2(bookVO);
	}


	@Override
	public List<BookInfoVO> bestSeller() {
		return mapper.bestSeller();
	}


	@Override
	public BookInfoVO bestBookInfo(String book_no) {
		return mapper.bestBookInfo(book_no);
	}


	@Override
	public List<BookInfoVO> koreaBookList() {
		
		return mapper.koreaBookList();
	}


	@Override
	public List<BookInfoVO> abroadBookList() {		
		return mapper.abroadBookList();
	}


	@Override
	public List<BookInfoVO> eBookList() {
		return mapper.eBookList();
	}


	@Override
	public List<BookInfoVO> searchCompareBook(String searchBook) {
		return mapper.searchCompareBook(searchBook);
	}
}
