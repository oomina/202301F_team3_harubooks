...
public class Ebook_PageVO<T> {
	   ...
	   public Ebook_PageVO(int screenSize, int blockSize) {
	      super();
	   ...
	   public String getPagingHTML() {
	         ...
	         html.append("<ul id='pagingBtns'>");

	         if (startPage > 1) {
	            html.append("<li class='page-item'><a href='' class='page-link page-add-link' data-page='" + (startPage - blockSize)
	                  + "'>Prev</a></li>");
	         }

	         for (int i = startPage; i <= (endPage < totalPage ? endPage : totalPage); i++) {
	            if (i == currentPage) {
	               html.append("<li class='page-item'><span class='page-link'>" + i + "</span></li>");
	            } else {
	               html.append(
	         ...
	         if (endPage < totalPage) {
	            html.append("<li class='page-item'><a href='' class='page-link page-add-link' data-page='" + (endPage + 1)
	                  + "'>Next</a></li>");
	         }
