...
<div class="content-wrapper" style="padding : 10px;">
	<div class="row" style=" padding : 10px;">
		<div class="col-lg-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title" style="font-size:1.25rem; font-family: 'orbit', sans-serif;">공지사항 상세</h4>
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="7" style="height : 250px;" >
										<textarea rows="20" cols="120" id="notice_content"></textarea>
									</td>
								</tr>
								<tr>
...
$(function(){
	fNoticeOne(no_no);
	let defendTitle = notice_title.value;
	let defendContent = notice_content.value;
	...
	xhr.onreadystatechange = function(){
		if(xhr.readyState == 4 && xhr.status == 200){
			...
			if(noOne.ua_no != "0"){
				...
				notice_ua_no.innerHTML = "첨부된 파일이 없습니다.";
			}
		}
	}
	xhr.send();
